...
/**
  chipcoin GUI main class. This class represents the main window of the chipcoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class chipcoinGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit chipcoinGUI(QWidget *parent = 0);
    ~chipcoinGUI();
