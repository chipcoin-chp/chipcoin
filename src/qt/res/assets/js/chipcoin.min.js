...
//         if (new_production_version && currentVersion && currentVersion != new_production_version && !$('#version-info-modal').is(':visible')) {
        if (bridge.checkVersion()) { // false if no new version
            ...
            // var bits = '64';
            // var osLink = 'http://www.chipcoin.org/media/wallets/chipcoin-' + newVersion + '-win' + bits + '.exe';
            // var osName = 'chipcoin Wallet '+newVersion+' (Windows ' + bits + ')';
            //
            ...
            //         var bits = '32';
            //     }
            //     var osLink = 'http://www.chipcoin.org/media/wallets/chipcoin-' + newVersion + '-linux.' + bits + '.tar.gz';
            //     var osName = 'chipcoin Wallet '+newVersion+' (Linux ' + bits + ')';
            //
            //
            ...
            //     var osLink = 'http://www.chipcoin.org/media/wallets/chipcoin-' + newVersion + '-macosx.dmg';
            //     var osName = 'chipcoin Wallet '+newVersion+' (MacOS)';
            //
            //
            // }
...
//             alert("Show version modal");
    ...
    //var reloadVersion = function () {
        ...
        //$.getScript("https://walletupdate.chipcoin.org/version.js?time=" + Date.now()).done(function (data, textStatus, jqxhr) {
...
function getAllLinks(version) {
    var links =
        '<a class="other-version-download" href="http://www.chipcoin.org/media/wallets/chipcoin-' + version + '-win64.exe">chipcoin Wallet ' + version + ' (Windows 64) </a></br>' +
        '<a class="other-version-download" href="http://www.chipcoin.org/media/wallets/chipcoin-' + version + '-win32.exe">chipcoin Wallet ' + version + ' (Windows 32) </a></br>' +
        '<a class="other-version-download" href="http://www.chipcoin.org/media/wallets/chipcoin-' + version + '-linux.64.tar.gz">chipcoin Wallet ' + version + ' (Linux 64) </a></br>' +
        '<a class="other-version-download" href="http://www.chipcoin.org/media/wallets/chipcoin-' + version + '-linux.32.tar.gz">chipcoin Wallet ' + version + ' (Linux 32) </a></br>' +
        '<a class="other-version-download" href="http://www.chipcoin.org/media/wallets/chipcoin-' + version + '-macosx.dmg">chipcoin Wallet ' + version + ' (MacOS) </a></br>';
    return links;
}
...
var unit = {
    ...
    setType: function (type) {
        ...
        switch (type) {
            ...
            case 2:
                this.name = "uCHP",
                    this.display = "&micro;CHP";
                break;

            case 3:
                this.name = "sCHP",
                    this.display = "chipcoinshi";
                break;

            default:
                this.name = this.display = "CHP";
        }
...
var overviewPage = {
    init: function () {
        this.balance = $(".balance"),
            this.chipcoinBal = $(".chipcoin_balance"),
    ...
    updateBalance: function (balance, chipcoinBal, stake, unconfirmed, immature) {
        if (balance == undefined)
            balance = this.balance.data("orig"),
                chipcoinBal = this.chipcoinBal.data("orig"),
            ...
            this.balance.data("orig", balance),
                this.chipcoinBal.data("orig", chipcoinBal),
        ...
        this.formatValue("chipcoinBal", chipcoinBal);
        this.formatValue("stake", stake);
        this.formatValue("unconfirmed", unconfirmed);
        this.formatValue("immature", immature);
        this.formatValue("total", balance + stake + unconfirmed + immature + chipcoinBal);
    },
...
function dumpStrings() {
    ...
    function buildStr(str) {
        return 'QT_TRANSLATE_NOOP("chipcoinBridge", "' + str + '"),\n';
    }
