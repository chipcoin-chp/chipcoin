...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::CHP).toInt();
    ...
    fAutoRedeemchipcoin = settings.value("fAutoRedeemchipcoin", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemchipcoin:
            return fAutoRedeemchipcoin;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemchipcoin: return "AutoRedeemchipcoin";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::CHP).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemchipcoin: {
            fAutoRedeemchipcoin = value.toBool();
            settings.setValue("fAutoRedeemchipcoin", fAutoRedeemchipcoin);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemchipcoin() { return fAutoRedeemchipcoin; }
