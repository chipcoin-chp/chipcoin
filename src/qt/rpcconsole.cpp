...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the chipcoin Core RPC console.") + "<br>" +
...
void RPCConsole::updateNodeDetail(const CNodeCombinedStats *stats)
{
    ...
    if (stats->nodeStats.nChainHeight > -1)
        ui->peerSyncHeight->setText(QString("%1").arg(stats->nodeStats.nChainHeight));
    else
