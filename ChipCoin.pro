...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.chipcoin
    BOOST_LIB_SUFFIX=-mt
...
contains(CHP_NEED_QT_PLUGINS, 1) {
    DEFINES += CHP_NEED_QT_PLUGINS
...
HEADERS += \
    ...
    src/qt/chipcoingui.h \
    src/qt/chipcoinbridge.h \
...
SOURCES += \
    ...
    src/qt/chipcoingui.cpp \
    src/qt/chipcoin.cpp \
    src/qt/chipcoinbridge.cpp
...
# also add new translations to chipcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/chipcoin*.ts)
